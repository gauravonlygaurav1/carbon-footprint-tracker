package carbon.tracker.backend.config;


import carbon.tracker.backend.Security.JwtAuthenticationFilter;
import carbon.tracker.backend.Security.OAuth2SuccessHandler;
import carbon.tracker.backend.dtos.ApiError;
...
//                                .requestMatchers(HttpMethod.GET).hasRole(AppConstants.USER_ROLE)
                                ...
                                .requestMatchers("/api/v1/emission/**").hasRole(AppConstants.USER_ROLE)
